...
#region WaveNumber
    ...
    public void StartCombinations()
    {
        ...
        combinations[1].combination = new int[] { 2,2,2,4,4,3,3};
        combinations[1].special = new int[] { 7,3,3,3,3,3,3,3 };
        combinations[2] = new Milestone();
        combinations[2].combination = new int[] { 4, 4, 4, 4, 2, 2, 2 };
        combinations[2].special = new int[] { 20,3,3,3,3,2,2,2,2,10};
        combinations[3] = new Milestone();
        combinations[3].combination = new int[] { 5, 5, 5, 5, 4, 4, 3, 3, 3, 3 };
